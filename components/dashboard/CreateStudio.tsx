      ...
      <div style={{
          ...
          <div style={{ display: 'flex', gap: 10, alignItems: 'flex-end' }}>
            ...
            <button
              ...
              style={{
                ...
                background: loading ? 'rgba(150,86,254,0.3)' : `linear-gradient(135deg, ${PURPLE}, ${PURPLE2})`,
                color: '#fff', fontSize: 13, fontWeight: 700, border: 'none',
                boxShadow: loading ? 'none' : '0 4px 18px rgba(150,86,254,0.4)',
        ...
        <div className="neon-card" style={{ ...GLASS, padding: '18px 20px', marginBottom: 14, flex: 1, display: 'flex', flexDirection: 'column' }}>
          ...
          <textarea
            ...
            onFocus={e => { e.target.style.borderColor = 'rgba(150,86,254,0.35)' }}
          ...
          {hashtags && (
            <div style={{
              ...
              background: 'rgba(150,86,254,0.06)', border: '1px solid rgba(150,86,254,0.15)',
            ...
            {MAGIC_ACTIONS.map(action => (
              <button
                ...
                style={{
                  ...
                  background: magicLoading === action.label ? 'rgba(150,86,254,0.25)' : 'rgba(255,255,255,0.06)',
                  border: `1px solid ${magicLoading === action.label ? 'rgba(150,86,254,0.4)' : 'rgba(255,255,255,0.1)'}`,
              ...
              >
                {magicLoading === action.label
                  ? <div style={{ width: 10, height: 10, border: '1.5px solid rgba(150,86,254,0.3)', borderTop: '1.5px solid #BE56FE', borderRadius: '50%', animation: 'spin 0.8s linear infinite' }} />
          ...
          {imageUrl ? (
            ...
            <div
              ...
              style={{
                ...
                background: dragOver ? 'rgba(150,86,254,0.06)' : 'transparent',
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            background: postText.trim() ? `linear-gradient(135deg, ${PURPLE}, ${PURPLE2})` : 'rgba(150,86,254,0.2)',
            border: 'none', color: '#fff', fontSize: 14, fontWeight: 800,
            boxShadow: postText.trim() ? '0 4px 24px rgba(150,86,254,0.45)' : 'none',
