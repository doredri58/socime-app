...
function SectionCard({ icon, iconBg, iconColor, title, subtitle, action, children, glow }: {
  ...
  return (
    <div className="neon-card" style={{ ...GLASS, padding: '24px', position: 'relative', overflow: 'hidden',
      ...(glow ? { borderColor: 'rgba(152,80,255,0.22)', background: 'rgba(152,80,255,0.04)' } : {}) }}>
      {glow && <div style={{ position: 'absolute', top: -40, right: -40, width: 130, height: 130,
        borderRadius: '50%', background: 'rgba(152,80,255,0.10)', filter: 'blur(45px)', pointerEvents: 'none' }} />}
          ...
          <div style={{ marginBottom: 18 }}>
            ...
            <div style={{ height: 8, borderRadius: 999, background: 'rgba(255,255,255,0.08)', overflow: 'hidden' }}>
              <div style={{
                ...
                boxShadow: `0 0 10px ${tokens < plan.tokenLimit * 0.2 ? 'rgba(248,113,113,0.4)' : 'rgba(152,80,255,0.4)'}`,
              }} />
            </div>
        ...
        <SectionCard
          ...
          action={
            <button onClick={() => setEditingBill(e => !e)} style={{
              ...
              display: 'flex', alignItems: 'center', gap: 6, boxShadow: editingBill ? '0 3px 12px rgba(152,80,255,0.3)' : 'none',
            }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
              ...
              <div style={{ gridColumn: '1 / -1', display: 'flex', justifyContent: 'flex-end', marginTop: 4 }}>
                <button onClick={saveBillingDetails} disabled={savingBill} style={{
                  ...
                  boxShadow: '0 4px 14px rgba(152,80,255,0.3)',
                }}>
                  {savingBill
                  ...
                  >
                    ...
                    <td style={{ padding: '14px 12px', borderBottom: '1px solid rgba(255,255,255,0.05)', color: 'rgba(255,255,255,0.75)', fontWeight: 600 }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        <div style={{ width: 28, height: 28, borderRadius: 8, background: 'rgba(152,80,255,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
