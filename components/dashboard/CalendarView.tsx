    ...
    <div style={{
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <button onClick={() => setShowUpgrade(true)} style={{
          ...
          background: 'linear-gradient(135deg, rgba(190,86,254,0.12), rgba(59,130,239,0.12))',
          border: '1px solid rgba(190,86,254,0.3)',
          ...
          <span style={{ marginRight: 'auto', display: 'flex', alignItems: 'center', gap: 4, padding: '2px 8px', borderRadius: 999, background: 'rgba(150,86,254,0.2)', border: '1px solid rgba(150,86,254,0.35)', color: PURPLE2, fontSize: 10, fontWeight: 800 }}>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          ...
          <button onClick={save} disabled={saving || !text.trim() || !platform.length} style={{
            ...
            background: text.trim() ? `linear-gradient(135deg, ${PURPLE}, ${PURPLE2})` : 'rgba(150,86,254,0.2)',
            border: 'none', color: '#fff', fontSize: 13, fontWeight: 800,
            boxShadow: text.trim() ? '0 4px 18px rgba(150,86,254,0.4)' : 'none',
          ...
          return (
            <div
              ...
              style={{
                ...
                background: isToday ? 'rgba(150,86,254,0.1)' : 'rgba(255,255,255,0.03)',
                border: isToday ? `1px solid rgba(150,86,254,0.35)` : '1px solid rgba(255,255,255,0.05)',
          ...
          <div key={i} style={{ opacity: isPast ? 0.6 : 1 }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                background: isToday ? 'rgba(150,86,254,0.15)' : 'transparent',
              }}>{d.getDate()}</div>
            </div>
            ...
            <div>
              ...
              <button
                ...
                onMouseEnter={e => {
                  (e.currentTarget as HTMLButtonElement).style.borderColor = `rgba(150,86,254,0.35)`
                  ;(e.currentTarget as HTMLButtonElement).style.color = PURPLE2
                  ;(e.currentTarget as HTMLButtonElement).style.background = 'rgba(150,86,254,0.06)'
                }}
                onMouseLeave={e => {
          ...
          <div style={{ display: 'flex', background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 12, padding: 3 }}>
            {(['month', 'week'] as const).map(v => (
              <button key={v} onClick={() => setView(v)} style={{
                ...
                boxShadow: view === v ? '0 2px 8px rgba(150,86,254,0.3)' : 'none',
                transition: 'all 0.2s',
              }}>
