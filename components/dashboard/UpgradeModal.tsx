    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: '0 32px 80px rgba(0,0,0,0.6), 0 0 0 1px rgba(152,80,255,0.1), 0 0 60px rgba(152,80,255,0.12)',
          display: 'flex',
        }}
      >
        {/* ── Left: features ── */}
        <div style={{
          ...
          background: 'linear-gradient(160deg, rgba(152,80,255,0.07) 0%, transparent 60%)',
        }}>
          {/* Pro badge */}
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 7, marginBottom: 18, padding: '5px 14px', borderRadius: 999, background: 'linear-gradient(135deg, rgba(152,80,255,0.2), rgba(59,130,239,0.15))', border: '1px solid rgba(152,80,255,0.35)' }}>
            ...
            {PLAN_FEATURES.map(f => (
              <div key={f.text} style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                <div style={{
                  ...
                  background: 'rgba(152,80,255,0.12)', border: '1px solid rgba(152,80,255,0.2)',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                }}>
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            ...
            <button
              ...
              style={{
                ...
                boxShadow: '0 6px 28px rgba(152,80,255,0.5)',
