  ...
  return (
    ...
    >
      ...
      <button onClick={() => onDuplicate(post)} style={{
        ...
        background: 'rgba(150,86,254,0.12)', border: '1px solid rgba(150,86,254,0.28)',
        color: PURPLE2, fontSize: 12, fontWeight: 700,
        display: 'flex', alignItems: 'center', gap: 6, transition: 'all 0.2s',
      }}
      onMouseEnter={e => { const b = e.currentTarget as HTMLButtonElement; b.style.background = 'rgba(150,86,254,0.22)'; b.style.boxShadow = '0 4px 14px rgba(150,86,254,0.25)' }}
      onMouseLeave={e => { const b = e.currentTarget as HTMLButtonElement; b.style.background = 'rgba(150,86,254,0.12)'; b.style.boxShadow = '' }}
      >
    ...
    <div style={{ direction: 'rtl', paddingBottom: 48 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 24, flexWrap: 'wrap', gap: 12 }}>
        ...
        <button onClick={() => !isPro && setShowUpgrade(true)} style={{
          ...
          boxShadow: isPro ? '0 4px 18px rgba(150,86,254,0.35)' : 'none',
        }}>
          <i className="ti ti-file-download" style={{ fontSize: 16 }} />
          הפקת דוח ללקוח (PDF)
          <span style={{ display: 'flex', alignItems: 'center', gap: 4, padding: '2px 8px', borderRadius: 999, background: isPro ? 'rgba(255,255,255,0.15)' : 'rgba(150,86,254,0.2)', border: isPro ? 'none' : '1px solid rgba(150,86,254,0.35)', fontSize: 10, fontWeight: 800, color: isPro ? '#fff' : PURPLE2 }}>
      ...
      <div style={{
        ...
        background: 'linear-gradient(135deg, rgba(150,86,254,0.14) 0%, rgba(59,130,239,0.10) 50%, rgba(190,86,254,0.08) 100%)',
        border: '1px solid rgba(150,86,254,0.28)',
      }}>
        {/* animated glow blobs */}
        <div style={{ position: 'absolute', top: -30, right: -30, width: 120, height: 120, borderRadius: '50%', background: 'rgba(150,86,254,0.15)', filter: 'blur(40px)', pointerEvents: 'none' }} />
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 16, position: 'relative' }}>
          {/* brain icon */}
          <div style={{ width: 44, height: 44, borderRadius: 14, background: 'rgba(150,86,254,0.2)', border: '1px solid rgba(150,86,254,0.35)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
      ...
      <div className="neon-card" style={{ ...GLASS, padding: '24px' }}>
        ...
        {topPosts.length === 0 && (
          <div style={{ marginTop: 8, padding: '12px 20px', borderRadius: 14, background: 'rgba(150,86,254,0.06)', border: '1px dashed rgba(150,86,254,0.2)', fontSize: 12, color: 'rgba(255,255,255,0.35)', textAlign: 'center' }}>
