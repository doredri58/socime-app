...
const FAQS: Record<string, { q: string; a: string }[]> = {
  ...
  create: [
    ...
    { q: 'איך מייצרים תמונה ב-AI?', a: 'בסטודיו היצירה, לאחר כתיבת הטקסט לחצו על "ייצר תמונה ב-AI". ניתן להוסיף תיאור ספציפי לתמונה הרצויה. כל תמונה עולה 25 טוקנים, ובנוסף יש מכסה חודשית: חינם 5 תמונות, Basic 30, Pro 100 ו-Agency 500. עוצרים במה שנגמר קודם — לרוב הטוקנים.' },
  ],
  schedule: [
