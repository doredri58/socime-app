...
const FAQS: Record<string, { q: string; a: string }[]> = {
  ...
  create: [
    ...
    { q: 'איך מייצרים תמונה ב-AI?', a: 'בסטודיו היצירה, לאחר כתיבת הטקסט לחצו על "ייצר תמונה ב-AI". ניתן להוסיף תיאור ספציפי לתמונה הרצויה. כל תמונה עולה 5 טוקנים — אין מכסת תמונות נפרדת, הטוקנים הם המגבלה היחידה.' },
  ],
  schedule: [
