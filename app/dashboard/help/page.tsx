...
const FAQS: Record<string, { q: string; a: string }[]> = {
  start: [
    ...
    { q: 'מה ההבדל בין המסלולים?', a: 'מסלול חינמי כולל 100 טוקנים AI לניסיון. מסלול Basic (199 ₪/חודש) כולל 500 טוקנים. מסלול Pro (299 ₪/חודש) כולל 1,000 טוקנים, רינדור מהיר בעדיפות ועורך וידאו AI. מסלול Agency (999 ₪/חודש) כולל 2,000 טוקנים וניהול עד 5 עסקים.' },
  ...
  create: [
    ...
    { q: 'כמה טוקנים עולה יצירת פוסט?', a: 'פוסט טקסט עולה 5 טוקנים, תמונת AI 10 טוקנים, וסרטון 20 טוקנים. בנק הרעיונות חינם. מספר הטוקנים המדויק מוצג לפני כל פעולה.' },
    ...
    { q: 'איך מייצרים תמונה ב-AI?', a: 'בסטודיו היצירה, לאחר כתיבת הטקסט לחצו על "ייצר תמונה ב-AI". ניתן להוסיף תיאור ספציפי לתמונה הרצויה. כל תמונה עולה 10 טוקנים — אין מכסת תמונות נפרדת, הטוקנים הם המגבלה היחידה.' },
  ],
  schedule: [
  ...
  account: [
    { q: 'איך משדרגים מסלול?', a: 'היכנסו ל"מצב חשבון" בסרגל הצד ולחצו על "שדרגו עכשיו". תועברו לדף התשלום המאובטח דרך PayPlus. השדרוג מיידי לאחר אישור התשלום.' },
