...
const FAQS: Record<string, { q: string; a: string }[]> = {
  start: [
    ...
    { q: 'מה ההבדל בין המסלולים?', a: 'מסלול חינמי כולל 100 טוקנים AI ו-5 פוסטים בחודש. מסלול Basic (₪79/חודש) כולל 500 טוקנים ו-30 פוסטים. מסלול Pro (₪149/חודש) כולל 1,500 טוקנים, פוסטים ללא הגבלה, תמיכת עדיפות ועורך וידאו AI.' },
  ...
  create: [
    ...
    { q: 'כמה טוקנים עולה יצירת פוסט?', a: 'יצירת פוסט טקסט עולה כ-10 טוקנים. יצירת תמונה AI עולה כ-25 טוקנים. עריכת וידאו AI עולה כ-15 טוקנים. מספר הטוקנים המדויק מוצג לפני כל פעולה.' },
    ...
    { q: 'באיזה פלטפורמות תומך הסטודיו?', a: 'כרגע: פייסבוק, אינסטגרם ולינקדאין. כל פלטפורמה מותאמת עם הגבלות תווים שונות ותצוגה מקדימה ייחודית.' },
  ...
  ai: [
    ...
    { q: 'על איזה מודל AI המערכת פועלת?', a: 'SociMe משתמשת ב-Claude Sonnet מבית Anthropic לכתיבת תוכן, ומודל נפרד לייצור תמונות. מוצגים מודלים מהדור האחרון בלבד לקבלת התוצאות הטובות ביותר.' },
    ...
    <div style={{ direction: 'rtl', maxWidth: 860, margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: 32, textAlign: 'center' }}>
        <div style={{
          ...
          background: 'linear-gradient(135deg, rgba(152,80,255,0.2), rgba(190,86,255,0.1))',
          ...
          {CATEGORIES.map(c => (
            <button key={c.id} onClick={() => { setActiveCategory(c.id); setOpenFaq(null) }} style={{
              ...
              background: activeCategory === c.id
                ? 'rgba(152,80,255,0.2)' : 'rgba(255,255,255,0.05)',
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 40 }}>
        ...
        {filtered.map((faq, i) => (
          <div key={i} style={{
            ...
            border: openFaq === i ? `1px solid rgba(152,80,255,0.3)` : '1px solid rgba(255,255,255,0.09)',
